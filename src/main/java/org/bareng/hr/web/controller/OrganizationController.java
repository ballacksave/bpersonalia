...
public class OrganizationController {
	...
	public String processRegistation(@ModelAttribute("command") Organization organization, BindingResult binding, SessionStatus status) {
	...
	public String processUpdate(@PathVariable("id") Integer id, Organization organization, BindingResult binding, SessionStatus status) {
		if(binding.hasErrors()) {
